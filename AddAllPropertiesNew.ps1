...
Write-Host "Adding ALL Editable Properties" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "3. Adding properties..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "4. Updating document type..." -ForegroundColor Yellow
